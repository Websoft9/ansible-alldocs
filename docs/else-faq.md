...
#### How can I enable the debug mode of Alldocs service?
...
#### Can I reset password of Alldocs by command?

Yes, e.g `rabbitmqctl change_password  admin newpassword`

#### If there is no domain name, can I deploy Alldocs?

Yes, access Alldocs by *http://Server's Internet IP:8161*.
...
#### Is it possible to modify the source path of Alldocs?
